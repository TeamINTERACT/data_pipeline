...
module list
# Python Env
virtualenv --no-download --clear venv_stepcount 
source venv_stepcount/bin/activate
pip install --no-index --upgrade pip
pip install stepcount
pip install --no-index sqlalchemy psycopg2
...
# numba                              0.58.0+computecanada
# numpy                              1.24.4+computecanada
# packaging                          23.1+computecanada
# pandas                             2.0.3+computecanada
...
# scikit_learn                       1.1.1+computecanada
