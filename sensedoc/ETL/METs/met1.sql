...
update top_sd.top_1min_mtl top
	set met = qux.met
from qux
...
update top_sd.top_1min_skt top
	set met = qux.met
from qux
where top.interact_id = qux.interact_id and top.utcdate = qux.utcdate;
...
update top_sd.top_1min_van top
	set met = qux.met
from qux
where top.interact_id = qux.interact_id and top.utcdate = qux.utcdate;
...
update top_sd.top_1min_vic top
	set met = qux.met
from qux
where top.interact_id = qux.interact_id and top.utcdate = qux.utcdate;
