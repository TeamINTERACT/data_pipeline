...
- `plg_participants-20241219.csv` : a download of the participant csv from the PLG dashboard on Dec 19th 
- `avicenna_study-3729-export-3-participation-2024-12-16-15-01-34.csv` : a download of the participant csv from the Avicenna dashboard on Dec 16th 
- `INT-VIC-SD-Participant-Tracking-W4-VIC.csv` : the sensedoc tracking document.
...
On 23 July 2024, we identified 27 participant accounts suspected of being frequently created to capitalize on the refer-a-friend $10 incentive bonus. These accounts were contacted by email (Notice of Unusual Activity Detected in Study Participation) and deactivated (‘Désactivé’ in PLG platform). 
